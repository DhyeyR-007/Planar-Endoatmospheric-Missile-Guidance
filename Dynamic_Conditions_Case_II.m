...
[TP, aP, PP, rhoP] = atmosisa(x(3)); % to compute speed of sound aP and air density rhoP at altitude hP
[TE, aE, PE, rhoE] = atmosisa(x(7)); % to compute speed of sound aE and air density  rhoE at altitude hE
[T0, a0, P0, rho0] = atmosisa(0);    % to compute ISA to air density rho0 at sea level
